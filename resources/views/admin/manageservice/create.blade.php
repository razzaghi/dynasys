...
{!! Form::open(array('files' => true, 'route' => 'admin.manageservice.store', 'id' => 'form-with-validation', 'class' => 'form-horizontal')) !!}

{{--<form action="admin/manageservice/store" id="form-with-validation" class="form-horizontal">--}}
