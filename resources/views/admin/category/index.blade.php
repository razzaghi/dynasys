                ...
                <table class="table table-striped table-hover table-responsive datatable" id="datatable">
                    ...
                    @foreach ($category as $row)
                        <tr>
                            ...
                            <td>{{ $row->Name }}</td>
                            {{--<td>{{ isset($row->parent[0]->id ) }}</td>--}}
                            <td>{{ isset($row->parent[0]->id) ? $row->parent[0]->Name : '' }}</td>
                            ...
                            <td>
                                ...
                                {!! Form::open(array('style' => 'display: inline-block;', 'method' => 'DELETE', 'onsubmit' => "return confirm('".trans("quickadmin::templates.templates-view_index-are_you_sure")."');",  'route' => array('admin.category.destroy', $row->id))) !!}
